...
@Service
@AllArgsConstructor
public class PasswordResetSessionVerificationService implements VerificationService {
    ...
    public String createToken(User user) {
        ...
        verificationToken.setTokenType(VerificationTokenType.PASSWORD_RESET_SESSION);
        verificationToken.setExpirationDate(LocalDateTime.now().plusSeconds(verificationConfig.getResetPasswordSessionVerificationTokenExpiration()));
    ...
    public User validateToken(String token) {
        ...
        if (verificationToken == null ||
            ...
            throw new InvalidRequestDataException("Invalid reset token.");
        }
    ...
    public void deleteTokens(User user) {
        verificationTokenRepository.deleteAllByUserAndTokenType(user, VerificationTokenType.PASSWORD_RESET_SESSION);
    }
}
